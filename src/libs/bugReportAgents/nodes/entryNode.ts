 ...
 */
export const bugEntryNode = async (state: any): Promise<{ [key: string]: any }> => {
    console.log("State in bugEntryNode:", state);
  ...
  try {
      ...
      console.log("EntryVars to be sent:", vars);
      ...
      console.log("Response from BugEntryRequest:", parsedResponse);
  
      const { askedQuestion } = parsedResponse;
      console.log("-----------------askedQuestion value:", askedQuestion);
